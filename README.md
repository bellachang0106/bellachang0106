# Hi there, I'm Bella Chang! 👋 

### 🛡️ Risk & Compliance Specialist | Financial Crime Investigation & Operational Excellence

I am a proactive Professional based in the UK, specializing in **Financial Crime (FinCrime) Investigation** and **Operational Risk Management**. With a career spanning from a global e-commerce giant (**Amazon**) to a leading UK financial services group (**Marston Holdings**), I excel at identifying complex risk patterns and transforming regulatory requirements into streamlined, efficient business processes.
...
| **KPMG Fraud Detection Project** | SQL & Transaction Monitoring | [View Project →](https://github.com/bellachang0106/amazon-fincrime-investigation-case-study) |
---
...
---
*"My goal is not just to find the risk, but to build a system where the risk has nowhere to hide."*
